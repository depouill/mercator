    ...
    public function run(): void
    {
        if (DB::table('permissions')->count() === 0) {
            DB::table('permissions')->insert([
                ...
                ['id' => 85, 'title' => 'application_flow_create'],
                ['id' => 86, 'title' => 'application_flow_edit'],
                ['id' => 87, 'title' => 'application_flow_show'],
                ['id' => 88, 'title' => 'application_flow_delete'],
                ['id' => 89, 'title' => 'application_flow_access'],
                ...
                ['id' => 106, 'title' => 'domain_create'],
                ['id' => 107, 'title' => 'domain_edit'],
                ['id' => 108, 'title' => 'domain_show'],
                ['id' => 109, 'title' => 'domain_delete'],
                ['id' => 110, 'title' => 'domain_access'],
                ...
                // Cartographers
                ['id' => 330, 'title' => 'cartographer_access'],
                ['id' => 331, 'title' => 'cartographer_create'],
